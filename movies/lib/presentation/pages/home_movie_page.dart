...
class _HomeMoviePageState extends State<HomeMoviePage>
    with AutomaticKeepAliveClientMixin<HomeMoviePage> {
  ...
  void initState() {
    ...
    if (movieListBloc.state is InitialMovieList) {
        ...
        child: SmartRefresher(
          ...
          child: BlocBuilder<MovieListBloc, MovieListState>(
            builder: (context, state) {
              ...
              return switch (state) {
                InitialMovieList() => EmptyStateWidget(
                  message:
                ...
                ErrorMovieList(message: final message) => () {
