...
import '../../bloc/movies/see_more_popular/see_more_popular_movie_bloc.dart';
...
class _PopularMoviesPageState extends State<PopularMoviesPage>
  ...
  void initState() {
    ...
    if (context.read<SeeMorePopularMovieBloc>().state is Initial) {
