...
import '../../bloc/movies/see_more_upcoming/see_more_upcoming_movie_bloc.dart';
...
class _UpComingMoviesPageState extends State<UpComingMoviesPage>
  ...
  void initState() {
    ...
    if (context.read<SeeMoreUpcomingMovieBloc>().state is Initial) {
          ...
          >(
            builder: (context, state) {
              return switch (state) {
                ...
                Loaded(upComing: final upComing) =>
                  upComing.isEmpty
                      ? EmptyStateWidget(
