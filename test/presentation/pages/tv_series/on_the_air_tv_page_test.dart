...
void main() {
  ...
  void _arrangeBlocState(SeeMoreOnTheAirTvState state) {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      // Arrange
      _arrangeBlocState(const SeeMoreOnTheAirTvState.loading());
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      // Arrange
      _arrangeBlocState(
        const SeeMoreOnTheAirTvState.loaded(
          onTheAir: [],
          onTheAirPage: 1,
          hasMoreOnTheAir: false,
        ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      // Arrange
      _arrangeBlocState(
        SeeMoreOnTheAirTvState.error('Failed to connect to the network'),
      );
  ...
  testWidgets('Page should display ErrorStateWidget2 for other errors', (
    ...
    // Arrange
    _arrangeBlocState(const SeeMoreOnTheAirTvState.error('Server Error'));
