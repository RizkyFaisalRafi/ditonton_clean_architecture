...
void main() {
  ...
  testWidgets('Page should display Lottie loading when state is Loading', (
    ...
    ).thenReturn(const WatchlistMovieState.loading());
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      when(
        mockWatchlistMovieBloc.state,
      ).thenReturn(const WatchlistMovieState.loaded(watchlistMovie: []));
      when(mockWatchlistMovieBloc.stream).thenAnswer((_) => Stream.empty());
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      when(
        mockWatchlistMovieBloc.state,
      ).thenReturn(const WatchlistMovieState.error(errorMessage));
      when(mockWatchlistMovieBloc.stream).thenAnswer((_) => Stream.empty());
