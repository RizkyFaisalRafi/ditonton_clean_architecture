...
@GenerateMocks([MovieListBloc, NavigatorObserver])
void main() {
      ...
      child: MaterialApp(
        ...
        routes: {
          SearchMoviePage.ROUTE_NAME:
              (_) => const Scaffold(body: Text('Search Movie')),
  ...
  group('Home Movie Page', () {
    ...
    testWidgets('Page should display loading indicator when state is Loading', (
      ...
      arrangeBlocsState(MovieListState.loading());
    ...
    testWidgets('Page should display error widget when state is Error', (
      ...
      arrangeBlocsState(const MovieListState.error(errorMessage));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        arrangeBlocsState(
          const MovieListState.error('Failed to connect to the network'),
        );
