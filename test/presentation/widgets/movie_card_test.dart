...
import 'package:ditonton_clean_architecture/common/constants.dart'; // Pastikan ini ada dan benar
...
void main() {
  ...
  group('MovieCard Widget Tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          '$BASE_IMAGE_URL${tMovie.posterPath}',
        );
    ...
    testWidgets('should navigate to MovieDetailPage when tapped', (
      ...
      expect(pushedRoute.settings.name, MovieDetailPage.ROUTE_NAME);
