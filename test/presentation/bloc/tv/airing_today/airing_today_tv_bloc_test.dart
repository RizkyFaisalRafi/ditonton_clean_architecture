...
void main() {
  ...
  test('initial state should be Initial', () {
    expect(airingTodayTvBloc.state, const AiringTodayTvState.initial());
  });
  ...
  group('FetchInitialTvS', () {
    ...
    blocTest<AiringTodayTvBloc, AiringTodayTvState>(
      ...
      act: (bloc) => bloc.add(const AiringTodayTvEvent.fetchInitialTvS()),
      expect:
          () => <AiringTodayTvState>[
    ...
    blocTest<AiringTodayTvBloc, AiringTodayTvState>(
      ...
      expect:
          () => <AiringTodayTvState>[
            const AiringTodayTvState.loading(),
            const AiringTodayTvState.loaded(
              airingToday: [],
              airingTodayPage: 2,
    ...
    blocTest<AiringTodayTvBloc, AiringTodayTvState>(
      ...
      expect:
          () => <AiringTodayTvState>[
            const AiringTodayTvState.loading(),
            const AiringTodayTvState.error('Server Failure'),
          ],
    );
  });
  ...
  group('RefreshTv', () {
    ...
    blocTest<AiringTodayTvBloc, AiringTodayTvState>(
      ...
      act: (bloc) => bloc.add(const AiringTodayTvEvent.refreshTv()),
      expect:
          () => <AiringTodayTvState>[
