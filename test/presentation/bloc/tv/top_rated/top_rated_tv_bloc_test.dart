...
void main() {
  ...
  test('initial state should be Initial', () {
    expect(topRatedTvBloc.state, const TopRatedTvState.initial());
  });
  ...
  group('FetchInitialTvS', () {
    ...
    blocTest<TopRatedTvBloc, TopRatedTvState>(
      ...
      act: (bloc) => bloc.add(const TopRatedTvEvent.fetchInitialTvS()),
      expect:
          () => <TopRatedTvState>[
        const TopRatedTvState.loading(),
    ...
    blocTest<TopRatedTvBloc, TopRatedTvState>(
      ...
      expect:
          () => <TopRatedTvState>[
        const TopRatedTvState.loading(),
        const TopRatedTvState.error('Server Failure'),
      ],
    );
  });
  ...
  group('RefreshTv', () {
    ...
    blocTest<TopRatedTvBloc, TopRatedTvState>(
      ...
      act: (bloc) => bloc.add(const TopRatedTvEvent.refreshTv()),
      expect:
          () => <TopRatedTvState>[
  ...
  group('FetchMoreTopRatedTv', () {
    ...
    blocTest<TopRatedTvBloc, TopRatedTvState>(
      ...
      seed:
        ...
        topRated: [],
        topRatedPage: 2,
        hasMoreTopRated: false, // Kondisi penting untuk tes ini
      ),
