...
import '../../../providers/tv_series/tv_list_notifier_test.mocks.dart';
...
void main() {
  ...
  test('initial state should be Initial', () {
    expect(popularTvBloc.state, const PopularTvState.initial());
  });
  ...
  group('FetchInitialTvS', () {
    ...
    blocTest<PopularTvBloc, PopularTvState>(
      ...
      act: (bloc) => bloc.add(const PopularTvEvent.fetchInitialTvS()),
      expect:
          () => <PopularTvState>[
            const PopularTvState.loading(),
    ...
    blocTest<PopularTvBloc, PopularTvState>(
      ...
      expect:
          () => <PopularTvState>[
            const PopularTvState.loading(),
            const PopularTvState.error('Server Failure'),
          ],
    );
  });
  ...
  group('RefreshTv', () {
    ...
    blocTest<PopularTvBloc, PopularTvState>(
      ...
      act: (bloc) => bloc.add(const PopularTvEvent.refreshTv()),
      expect:
          () => <PopularTvState>[
