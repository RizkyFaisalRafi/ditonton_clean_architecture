...
void main() {
  ...
  test('initial state should be Initial', () {
    expect(onTheAirTvBloc.state, const OnTheAirTvState.initial());
  });
  ...
  group('FetchInitialTvS', () {
    ...
    blocTest<OnTheAirTvBloc, OnTheAirTvState>(
      ...
      expect:
          () => <OnTheAirTvState>[
            const OnTheAirTvState.loading(),
            const OnTheAirTvState.error('Server Failure'),
          ],
    );
  });
