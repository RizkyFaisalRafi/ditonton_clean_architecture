...
void main() {
  ...
  group('get Upcoming Movies', () {
    ...
    test(
      'should return list of movies when the response code is 200',
      () async {
        // arrange
        when(
          mockHttpClient.get(Uri.parse('$BASE_URL/movie/upcoming?$API_KEY')),
        ).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/upcoming.json'), 200),
        );
        // act
