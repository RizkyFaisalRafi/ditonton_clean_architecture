...
void main() {
  ...
  group('GetPopularMovies Tests', () {
    test(
      'should get popular movies from the repository with correct page number',
      () async {
        // arrange
        when(
        ...
        verify(mockMovieRepository.getPopularMovies(page: tPage));
    ...
    test('should handle invalid page numbers (negative or zero)', () async {
      ...
      verify(mockMovieRepository.getPopularMovies(page: 0));
      verifyNoMoreInteractions(mockMovieRepository);
    });
    ...
    test('should return error when page number is too large', () async {
      ...
      when(
        mockMovieRepository.getPopularMovies(page: largePage),
      ...
      verify(mockMovieRepository.getPopularMovies(page: largePage));
      verifyNoMoreInteractions(mockMovieRepository);
    });
  });
}
