...
class _TopRatedTvPageState extends State<TopRatedTvPage>
  ...
  void initState() {
    ...
    if (context.read<SeeMoreTopRatedTvBloc>().state
        is InitialTopRatedTSeeMore) {
      ...
      body: Padding(
        ...
        child: BlocListener<SeeMoreTopRatedTvBloc, SeeMoreTopRatedTvState>(
          listener: (context, state) {
            ...
            if (state is ErrorTopRatedTSeeMore) {
          ...
          child: BlocBuilder<SeeMoreTopRatedTvBloc, SeeMoreTopRatedTvState>(
            builder: (context, state) {
              return switch (state) {
                ...
                LoadedTopRatedTSeeMore(topRatedTv: final topRatedTv) =>
                  topRatedTv.isEmpty
                      ? EmptyStateWidget(
                ...
                ErrorTopRatedTSeeMore(message: final message) => () {
