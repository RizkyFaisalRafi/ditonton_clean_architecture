...
class _OnTheAirTvPageState extends State<OnTheAirTvPage>
  ...
  void initState() {
    ...
    if (context.read<SeeMoreOnTheAirTvBloc>().state
        is InitialOnTheAirTSeeMore) {
          ...
          child: BlocBuilder<SeeMoreOnTheAirTvBloc, SeeMoreOnTheAirTvState>(
            builder: (context, state) {
              return switch (state) {
                ...
                LoadedOnTheAirTSeeMore(onTheAir: final onTheAir) =>
                  onTheAir.isEmpty
                      ? EmptyStateWidget(
                ...
                ErrorOnTheAirTSeeMore(message: final message) => () {
